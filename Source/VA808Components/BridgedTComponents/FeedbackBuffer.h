/*
  ==============================================================================
    ...
    Class that represents the feedback buffer input of the bridged-T network.
    Contains two classes for managing transfer functions:
        1) between the feedback buffer input and network output 
                        V_fb ---> V_bt2
        2) between the feedback buffer input and the intermediate node
                        V_fb ---> V_c2
  ==============================================================================
*/
...
private:
    /// coefficients of the discretized transfer functions for bridged-T network, for V_fb ---> V_bt2
    float A0 = 0.0f;
    float B0 = 0.0f;
    float B2 = 0.0f;
    float A1 = 0.0f;
...
private:
    /// coefficients of the discretized transfer functions for bridged-T network, for V_fb ---> V_c2
    float A0 = 0.0f;
    float B0 = 0.0f;
    float B1 = 0.0f;
    float B2 = 0.0f;
